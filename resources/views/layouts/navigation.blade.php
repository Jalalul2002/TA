<nav x-data="{ open: false }" class="fixed top-0 z-50 w-full bg-uinBlue">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <button @click="openSidebar = !openSidebar" type="button"
                    class="inline-flex items-center text-sm text-white px-2 hover:bg-sky-700 md:hidden">
                ...
                <button @click="openSidebar = !openSidebar" type="button"
                    class="inline-flex items-center text-sm text-white md:px-2 hover:bg-sky-700">
                    <span class="sr-only">Open sidebar</span>
                    <div class="flex me-4 text-white px-2 py-3">
                    ...
                    <svg class="w-6 h-6 hidden md:inline-flex" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path clip-rule="evenodd" fill-rule="evenodd"
                            d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z">
                        </path>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 px-4 xl:px-8 py-3">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div
                            class="group relative flex items-center gap-x-6 rounded-lg p-2 text-sm/6 hover:bg-uinBlue transition-all duration-300">
                            <div
                            ...
                            <a href="{{ route('profile.edit') }}"
                                class="block font-semibold text-gray-900 hover:text-white transition-all duration-300">
                                Profile
            ...
            <div class="-me-2 flex items-center sm:hidden p-3">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-uinYellow  focus:outline-none focus:text-uinYellow transition duration-150 ease-in-out">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 shadow-md bg-white">
            <div class="px-4">
            ...
            <div class="mt-3 space-y-1">
                <div
                    class="group relative flex items-center gap-x-6 rounded-lg p-2 text-sm/6 hover:bg-uinBlue transition-all duration-300">
                    <div
                        class="flex font-bold text-gray-900 size-11 leading-none flex-none items-center justify-center rounded-lg bg-gray-100 group-hover:bg-white group-hover:text-uinBlue transition-all duration-300">
                        <p><i class="fi fi-rr-circle-user leading-none text-xl"></i></p>
                    </div>
                    <a href="{{ route('profile.edit') }}"
                        class="block font-semibold text-gray-900 hover:text-white transition-all duration-300">
