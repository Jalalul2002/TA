                ...
                <table class="w-full border-collapse border border-gray-300 text-sm">
                    <thead>
                        <tr class="bg-gray-200 text-gray-700">
                            <th class="border border-gray-300 px-3 py-2">ID Pengguna</th>
                            <th class="border border-gray-300 px-3 py-2">Nama Pengguna</th>
                            <th class="border border-gray-300 px-3 py-2">Prodi</th>
                            <th class="border border-gray-300 px-3 py-2">Telepon</th>
                        ...
                        @foreach ($data as $row)
                            @foreach ($row->items as $item)
                                <tr class="hover:bg-gray-100">
                                    <td class="border border-gray-300 px-3 py-2">{{ $row->user_id }}</td>
                                    <td class="border border-gray-300 px-3 py-2">{{ $row->name }}</td>
                                    <td class="border border-gray-300 px-3 py-2">{{ $row->prodi }}</td>
                                    <td class="border border-gray-300 px-3 py-2">{{ $row->telp }}</td>
                                    <td class="border border-gray-300 px-3 py-2">{{ $item->asset->product_name }}</td>
                                    <td class="border border-gray-300 px-3 py-2">{{ $item->asset->merk }}</td>
                                    <td class="border border-gray-300 px-3 py-2">{{ $item->asset->product_type }}</td>
                                    <td class="border border-gray-300 px-3 py-2">{{ $item->asset->product_unit }}</td>
                                    ...
                                    <td class="border border-gray-300 px-3 py-2">{{ $row->created_at->format('d/m/Y') }}</td>
                                </tr>
                            @endforeach
                        @endforeach
                    </tbody>
