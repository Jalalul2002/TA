        ...
        <div class="max-w-full mx-auto sm:px-3 lg:px-6 grid sm:grid-cols-2 xl:grid-cols-3">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg w-full p-5 space-y-4 rounded-lg">
                ...
                <form action="/send-data" method="POST" enctype="multipart/form-data" x-data="{ fileName: '' }">
                    ...
                    <button type="submit"
                        class="w-full mt-4 px-4 py-2 text-white bg-uinBlue rounded-lg hover:bg-uinNavy">Upload</button>
                    @error('csv_file')
                    ...
                    <div
                        ...
                        <div class="mr-4">
                            <a href="/perencanaan-bhp"
                                class="inline-flex items-center gap-x-2 px-4 py-2 rounded-lg text-white bg-uinBlue hover:bg-uinYellow w-full">
