...
<body class="max-h-screen font-sans text-gray-900 antialiased bg-sky-50">
	<div class="max-w-6xl mx-auto py-8">
		<div
			class="header bg-uinBlue p-5 rounded-3xl text-white flex justify-between items-center animate__animated animate__fadeInUp animate__slow">
			<div class="flex items-center gap-x-8">
				<a href="/">
					<i class="fi fi-sr-angle-circle-left text-3xl hover:text-uinOrange leading-none"></i>
				</a>
				<a href="/">
					<div class="flex items-center gap-x-2">
						<img src="Logo-UIN-Putih.png" alt="Logo UIN" class="h-10">
						<div>
							<h1 class="font-semibold text-xl leading-none">Laboratorium Terpadu</h1>
							<h2 class="text-sm">Fakultas Sains dan Teknologi</h2>
						</div>
					</div>
				</a>
			</div>
	...
	<footer class="max-w-6xl pt-36 mx-auto text-center animate__animated animate__zoomIn">
		<span class="text-sm text-gray-500 sm:text-center">© 2024 <a href="#" class="hover:underline">Made
				with</a>. ❤️and☕
		</span>
	</footer>
</body>
