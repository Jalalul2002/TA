                    ...
                    <div
                        ...
                        <div x-data="filterData()" class="flex items-center gap-x-2">
                            <form action="{{ route('export.bhp') }}" method="GET" class="flex items-center gap-2">
                                ...
                                <div>
                                    <button type="submit"
                                        class="inline-flex text-sm items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-white hover:bg-green-800 transition-all duration-300">
                                        Export Excel
                                    </button>
                                </div>
                            </form>
                            @if (Auth::user()->usertype !== 'user')
                                <a href="{{ route('add-aset-bhp') }}"
