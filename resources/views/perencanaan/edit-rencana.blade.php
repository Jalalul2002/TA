                ...
                <form method="POST" action="{{ route('rencana.update-rencana', $item->id) }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="product_type" class="block mt-1 w-full" product_type="text"
                            name="product_type" :value="old('product_type', $item->product->product_type)" readonly disabled
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="stock" class="block mt-1 w-full" type="text" name="stock"
                            :value="old('stock', $item->product->stock)" readonly disabled autocomplete="stock" />
                        <x-input-error :messages="$errors->get('stock')" class="mt-2" />
                    </div>
                    <div class="mt-4">
                        <x-input-label for="jumlah_kebutuhan" :value="__('Jumlah Kebutuhan *')" />
                        <x-text-input id="jumlah_kebutuhan" class="block mt-1 w-full bg-green-50 border-green-300" type="text"
