            ...
            <div class="bg-white shadow-sm sm:rounded-lg py-4 px-16 mb-4">
                <div
                    ...
                    <div>
                        ...
                        <h1 class="text-lg font-bold {{ $dataPerencanaan->status == 'belum' ? 'text-red-500' : 'text-green-500' }}">{{ strtoupper($dataPerencanaan->status) }}</h1>
                    </div>
                    <div>
                            ...
                            @forelse ($products as $product)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <form action="{{ route('rencana.destroy-item', $product->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
