<x-app-layout>
    ...
    @if ($errors->any())
        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 10000)" x-show="show"
            class="fixed top-20 right-10 p-3 rounded-md shadow-md transition-all duration-500 bg-red-500 text-white"
    ...
    function formHandler() {
        return {
            ...
            calculateTotalPrice(index) {
                this.items[index].total_price = this.items[index].price * this.items[index].quantity;
            },
